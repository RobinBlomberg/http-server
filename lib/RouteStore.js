 ...
 * @typedef {import('../main').Parameters} Parameters
 * @typedef {import('../main').RequestHandler} RequestHandler
 * @typedef {import('../main').RequestHandlersPayload} RequestHandlersPayload
 * @typedef {import('../main').RequestHandlerTree} RequestHandlerTree
 * @typedef {import('../main').RouteMatch} RouteMatch
 */
